...
if isempty(emissivity);emissivity=str2num(exifdata{52,2});end %get emissivity
if isempty(distance);distance=strsplit(exifdata{53,2});distance=str2num(distance{1});end %get object distance
if isempty(Tr);Tr=strsplit(exifdata{54,2});Tr=str2num(Tr{1});end %get reflected temperature
if isempty(Ta);Ta=strsplit(exifdata{55,2});Ta=str2num(Ta{1});end %get atmospheric temperature
if isempty(RH);RH=strsplit(exifdata{58,2});RH=str2num(RH{1});end %get relative humidity
